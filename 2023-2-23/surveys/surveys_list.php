<?php
/**
 * surveys_list_pager.php along with surveys_view.php provides a sample web application
 * 
 * @package SurveySez
...
{#records exist - process
	...
	{# process each row
		...
		echo '
		<tr>
			<th scope="row"><a href="' . VIRTUAL_PATH . 'surveys/survey.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . '</a></th>
        ...
        //  echo '<div align="center"><a href="' . VIRTUAL_PATH . 'surveys/survey.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . '</a>';
        //  echo '</div>';
	}
		echo '
			</tbody>
